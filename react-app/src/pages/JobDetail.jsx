                                    ...
                                    <div className="flex flex-wrap gap-6">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium text-gray-900">
                                                    {new Date(job.publishedAt || job.createdAt).toLocaleDateString('en-US', {
                                                        month: 'short',
                                                        day: 'numeric',
                                                        year: 'numeric'
                                                    })}
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium text-gray-900">{job.applicationCount || 0}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 lg:p-8 space-y-8">
                                    ...
                                    {job.qualifications && (
                                        <div>
                                            ...
                                            <p className="text-gray-600 whitespace-pre-line">{job.qualifications}</p>
                                        </div>
                                    )}
                            ...
                            <div className="sticky top-24 space-y-6">
                                ...
                                >
                                    {hasApplied ? (
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-600 text-sm mb-4">
                                                You've already applied for this position. Track your application status in your dashboard.
                                            </p>
                                            <Link
                                                to="/my-applications"
                                    ...
                                    <div className="flex gap-3 mt-4">
                                        <button
                                            ...
                                            disabled={saving}
                                            className={`flex-1 py-3 rounded-xl font-semibold text-sm transition-all flex items-center justify-center gap-2 ${isSaved
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900">{company.name || 'Company'}</h4>
                                            {company.industry && (
