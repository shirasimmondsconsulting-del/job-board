...
import {
    ...
    Linkedin, ExternalLink, ArrowLeft, Loader, FileText,
            ...
            <section className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 py-12">
                <div className="container-custom">
                    ...
                    <div className="flex flex-col md:flex-row items-start gap-6">
                        ...
                        {/* Contact Button */}
                        {profile.email && currentUser?.userType === 'employer' && (
                            <a
                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            ...
                                            <p className="font-semibold text-gray-900">{profile.experience.yearsOfExperience} years</p>
                                        </div>
                                        {profile.experience.previousCompanies?.length > 0 && (
                                            <div>
                                                <span className="text-sm text-gray-500">Previous Companies</span>
                                                <div className="flex flex-wrap gap-2 mt-1">
                                                    {profile.experience.previousCompanies.map((company, i) => (
                                                        <span
                                                            key={i}
                                ...
                                >
                                    ...
                                    <div className="space-y-1">
                                        <p className="font-semibold text-gray-900">
                                            {profile.education.degree} in {profile.education.fieldOfStudy}
                                        </p>
                                        <p className="text-gray-600">{profile.education.university}</p>
                                        <p className="text-sm text-gray-500">Graduated {profile.education.graduationYear}</p>
                                    </div>
                                </motion.div>
                            )}
                        </div>
