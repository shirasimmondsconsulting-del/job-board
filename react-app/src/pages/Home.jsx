          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-lg mb-10">
                The #1 job platform connecting talented professionals making
                Aliyah with Israeli companies ready to hire.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <Link
                  to="/jobs"
                  className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold group"
                >
                  Explore Jobs
                ...
                <Link
                  to="/companies"
                  className="inline-flex items-center gap-2 px-8 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-semibold"
                >
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/20 group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end p-6 lg:p-8">
                    <div>
                      ...
                      <p className="text-blue-100 text-sm lg:text-base italic">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-xl mx-auto">
              Create your profile and let Israeli companies discover you. Get
              matched with opportunities that fit your skills and timeline.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                to="/jobs"
                className="inline-flex items-center gap-2 px-8 py-3 bg-white/10 text-white border border-white/20 rounded-lg hover:bg-white/20 font-semibold backdrop-blur-sm"
              >
                Browse Jobs
      ...
      <section className="py-16 lg:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-10">
            ...
            <Link
              to="/jobs"
              className="inline-flex items-center gap-2 px-6 py-2 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-semibold"
            >
              View All Jobs
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {(jobs && jobs.length > 0 ? jobs.slice(0, 6) : []).map(
              (job, index) => (
                <motion.div
                  key={job._id || index}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <Link
                      ...
                      className="text-blue-700 text-sm font-semibold hover:text-blue-800"
                    >
                      View Details →
                    </Link>
                  </div>
